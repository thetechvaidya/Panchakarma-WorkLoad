...
export const PROCEDURE_GRADES: Record<string, ProcedureGradeInfo> = {
  ...
  'ssps': { grade: 1, points: 3, name: 'Shashik-Shali Pinda Swedana' },
  'shashik-shali pinda swedana': { grade: 1, points: 3, name: 'Shashik-Shali Pinda Swedana' },
  'nirhua basti': { grade: 1, points: 3, name: 'Nirhua Basti' },
  'nb': { grade: 1, points: 3, name: 'Nirhua Basti' },
  'saravang abhyang + potali': { grade: 1, points: 3, name: 'Saravang Abhyang + Potali' },
  'shiro-basti': { grade: 1, points: 3, name: 'Shiro-Basti' },
  'sarvang parikshek': { grade: 1, points: 3, name: 'Sarvang Parikshek' },
  'pizhichil': { grade: 1, points: 3, name: 'Pizhichil' },
  'sarvanag dhara': { grade: 1, points: 3, name: 'Sarvanag Dhara' },
  'sarvang udwartana': { grade: 1, points: 3, name: 'Sarvang Udwartana' },
  ...
  'sthanik potali + abhyang': { grade: 2, points: 2, name: 'Sthanik Potali + Abhyang' },
  'sarvang abhyanga swedan': { grade: 2, points: 2, name: 'Sarvang Abhyanga Swedan' },
  'pps': { grade: 2, points: 2, name: 'Sthanik Abhyang + Potali (PPS)' },
  'jps': { grade: 2, points: 2, name: 'Sthanik Abhyang + Potali (JPS)' },
  'sthanik ruksha swedana': { grade: 2, points: 2, name: 'Sthanik Ruksha Swedana' },
  'ruksha sweda': { grade: 2, points: 2, name: 'Ruksha Sweda' },
  'upanhana': { grade: 2, points: 2, name: 'Upanhana' },
  'sthanik dhara/parishek': { grade: 2, points: 2, name: 'Sthanik Dhara/Parishek' },
