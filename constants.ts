...
export const PROCEDURE_GRADES: Record<string, ProcedureGradeInfo> = {
  ...
  // Grade 3 - Low intensity (3 points)
  'sthanika abhyanga swedana': { grade: 3, points: 3, name: 'Sthanika Abhyanga Swedana' },
  'abhyanga swedan': { grade: 3, points: 3, name: 'Abhyanga Swedan' },
  'abhyanga': { grade: 3, points: 3, name: 'Abhyanga' },
  'pichu': { grade: 3, points: 3, name: 'Pichu' },
  'shiroabhyanga': { grade: 3, points: 3, name: 'Shiroabhyanga' },
  'sarvang swedan': { grade: 3, points: 3, name: 'Sarvang Swedan' },
  'anuvasan basti': { grade: 3, points: 3, name: 'Anuvasan Basti' },
  'ab': { grade: 3, points: 3, name: 'Anuvasan Basti' },
  'matra basti': { grade: 3, points: 3, name: 'Matra Basti' },
  'lepa': { grade: 3, points: 3, name: 'Lepa' },
  'udar lepa': { grade: 3, points: 3, name: 'Udar Lepa' },
  'karnapurana': { grade: 3, points: 3, name: 'Karnapurana' },
  'tarpana': { grade: 3, points: 3, name: 'Tarpana' },
  'vesthana': { grade: 3, points: 3, name: 'Vesthana' },
  'avgah sweda': { grade: 3, points: 3, name: 'Avgah Sweda' },
  'pachan': { grade: 3, points: 3, name: 'Pachan' },
  'deepan pachan': { grade: 3, points: 3, name: 'Deepan Pachan' },
};
